		...
		<div class="page__title-row">
			...
			<div class="page__copy">
				...
				<p class="page__subtitle">
					Addresses on this list never receive sends, regardless of template or member preference.
					Bounces and complaints feed in automatically; manual entries below cover ops-driven
					blocks.
				</p>
			</div>
		</div>
							...
							<tr>
								...
								<td class="row-actions">
									...
									>
										...
										<span>{removingEmail === row.email ? 'Removing…' : 'Remove'}</span>
									</button>
								</td>
							</tr>
						{/each}
	...
	{#if drawerOpen}
		...
		<aside class="drawer" aria-label="Add suppression">
			...
			<div class="form">
				...
				<p class="hint">
					Sends to this address will fail with a permanent suppression error until the row is
					removed. The audit log captures who added it.
				</p>
