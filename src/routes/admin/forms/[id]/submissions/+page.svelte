...
<style>
	...
	.bulkbar { display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap; padding: 0.75rem 1rem; margin-bottom: 1rem; background: rgba(15, 164, 175, 0.08); border: 1px solid rgba(15, 164, 175, 0.25); border-radius: var(--radius-2xl); }
