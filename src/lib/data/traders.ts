...
export const traders: Trader[] = [
	{
		...
		tagline:
			'Former lead trader at Simpler Trading. Creator of "The Move Prior to The Move" methodology. Mentored by Goldman Sachs.',
		...
		bio: [
			...
			'After recovering from cancer, Billy shifted his focus toward sustainable, high-impact trading education. He now leads <strong>Precision Options Signals</strong> and <strong>Revolution Trading Pros</strong>, serving over <strong>18,000 active traders</strong>.'
		],
		highlights: [
	...
	},
	{
		...
		role: 'Senior Trader',
		tagline:
			'Disciplined swing trader with a sharp eye for high-probability setups and clean risk-to-reward entries.',
		...
		bio: [
			...
			"With deep expertise in <strong>technical analysis</strong> and <strong>price action</strong>, Freddie brings a complementary edge to the Precision Options Signals watchlist - helping surface setups that meet the team's rigorous standards for quality and clarity.",
