...
#[openapi(
    ...
    paths(
        ...
        // Member orders + subscription history + plan-switch (Phase 5)
        member::list_orders,
        member::get_order_detail,
        member::list_subscriptions,
        member::get_subscription_detail,
        member::post_cancel_subscription,
        member::post_resume_subscription,
        member::post_pause_subscription,
        member::post_unpause_subscription,
    ...
    components(
        schemas(
            ...
            // Member orders + subscription history (Phase 5)
            member::MemberOrderListItem,
            member::MemberOrderRefund,
            member::MemberOrderStateTransition,
            member::MemberOrderDetailResponse,
            member::PaginatedMemberOrdersResponse,
            member::MemberOrdersListQuery,
            member::MemberSubscriptionListItem,
            member::PaginatedMemberSubscriptionsResponse,
            member::MemberSubscriptionsListQuery,
            member::MemberSubscriptionInvoice,
            member::MemberSubscriptionDetailResponse,
            member::PauseSubscriptionRequest,
            member::SwitchPlanRequest,
