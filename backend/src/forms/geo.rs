...
const MX_STATES: [(&str, &str); 32] = [
    ...
    ("MX-COA", "Coahuila"), ("MX-COL", "Colima"), ("MX-CMX", "Mexico City"),
    ("MX-DUR", "Durango"), ("MX-GUA", "Guanajuato"), ("MX-GRO", "Guerrero"),
    ("MX-HID", "Hidalgo"), ("MX-JAL", "Jalisco"), ("MX-MEX", "México"),
...
const BR_STATES: [(&str, &str); 27] = [
    ...
    ("BR-PA", "Pará"), ("BR-PB", "Paraíba"), ("BR-PR", "Paraná"),
    ("BR-PE", "Pernambuco"), ("BR-PI", "Piauí"), ("BR-RJ", "Rio de Janeiro"),
    ("BR-RN", "Rio Grande do Norte"), ("BR-RS", "Rio Grande do Sul"), ("BR-RO", "Rondônia"),
    ("BR-RR", "Roraima"), ("BR-SC", "Santa Catarina"), ("BR-SP", "São Paulo"),
...
mod tests {
    ...
    fn states_for_us_returns_51_entries_with_dc() {
        let s = states_for("US");
        assert_eq!(s.len(), 51);
        assert!(s.iter().any(|x| x.code == "US-CA" && x.name == "California"));
