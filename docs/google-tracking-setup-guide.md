...
“CAPI” in ads/analytics circles often refers to **server-side** or **API-based** event delivery (Meta calls theirs _Conversions API_). Google’s closest concepts are:
...
_Last updated to reflect the Swings codebase layout. If you add GA4, GTM, Ads, or reCAPTCHA, update this file with the exact env var names and file paths you introduce._
