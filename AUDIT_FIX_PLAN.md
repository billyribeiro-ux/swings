...
The strict definition of "stops a build" yields **no current blockers**. However, the items below are _runtime_ blockers (production endpoints 404, security advisories, broken auth flows) that should be treated with Phase 1 urgency:
